...
feature_list = np.array(pickle.load(open('featurevactor.pkl', 'rb')))
...
img=cv2.imread("3559.jpg")
cv2.imshow("input Frame", cv2.resize(img, (640,480)))
